...
def build_section_user(intent: StructuredIntent, *, kind: str, title: str, objective: str | None) -> str:
    ...
    return (
        ...
        "stem_markdown, typed payload, distractors (each with a misconception string or null), "
...
def build_quiz_user(
    ...
    *,
    ...
    return (
        ...
        "distractors (each with a misconception string or null). List options in no fixed order — do "
