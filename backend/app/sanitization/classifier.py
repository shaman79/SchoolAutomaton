...
CLASSIFIER_SYSTEM_PROMPT = (
    ...
    "(<=120 chars, NO instructions), study vs test mode, grade_band, school_year, age if stated, "
    "language (ISO-639-1, the language the STUDENT wrote in), whether it is genuinely educational, "
    "whether it is off-task (not a learning request), any child-safety flags, and your confidence "
    "(0..1). Output ONLY the structured fields.\n\n"
    "school_year: the learner's exact school year ONLY when the text states or clearly implies it, "
    "counted from the first year of compulsory primary school (1 = first grade, age 6-7; "
    "0 = kindergarten/preschool); otherwise null — never guess it from the topic, and leave it null "
    "when only an age is given. Conversions: US 'Grade N' = N; UK 'Year N' = N-1 (Reception = 0); "
    "Czech 'N. třída' or 'N. ročník' of základní škola = N (e.g. 'páťák' = 5, 'předškolák' = 0); "
    "Czech 'N. ročník' of a secondary school (SŠ, gymnázium, SOŠ, SOU) = 9+N; eight-year gymnázium "
    "prima..oktáva = 6..13; six-year gymnázium prima..sexta = 8..13; 'přijímačky na SŠ' = 9, "
    "'přijímačky na osmileté gymnázium' = 5, 'přijímačky na šestileté gymnázium' = 7, "
    "'maturita' = 13. Keep grade_band consistent with it (0 = K, 1-2 = G1-2, 3-5 = G3-5, "
    "6-8 = G6-8, 9-13 = G9-12)."
)
