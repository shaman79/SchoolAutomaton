...
| 9 | i18n scope | UI ships **`en` + `cs`** (Czech) at launch; generation auto-detects ANY language. Native pedagogy cached prefixes built for `en` + `cs`; other languages use the English pedagogy prefix + "respond entirely in {language}". |
